var contentList = [
    "Tens of thousands of former mineworkers and their families survive today; many are sickly and live in remote, rural areas across Southern Africa. <bold>Scroll down to read their stories</bold>.",
    ...
    "His children sit on the porch and play a game of stone-toss-and-pick-up called kudoda. \"When I see them in the mornings, I\’m alive,\” <p>Mdluli</p> says.",
  	...
  	"Small dust particles breathed in while cutting and grinding through the depths of the Earth at the Western Areas gold mine have led to him contracting silicosis. He was made redundant 14 years ago. \“The mines don’t want iskorokoro,\” he says.",
  	...
  	"<p>Mdluli</p> has only one lung left and wheezes when he trudges. \“The one is fucked up,\” he says angrily.",
  	...
  	"\“When I was retrenched from the mines in 2004, the doctors told me I will be compensated in Eswatini. But nothing happened,\” <p>Lukhele</p> recalls.",
    ...
    "<p>Dumisile Dlamini</p> works at Hlathikhulu\’s occupational health service centre in Eswatini. She says that treatments are expensive and difficult to access for struggling patients.",
